					...
					<td>
						...
						<?php if($pecah['status_pembelian'] == 'pending'): ?>
							...
							<?php else: ?>
								...
								<a href="konfirmasi.php?id=<?= $pecah['id_pembelian']; ?>" class="btn btn-success">konfirmasi</a>
								
						<?php endif; ?>


						<?php if($pecah['status_pembelian'] == 'sudah kirim pembayaran'): ?>
							<a href="konfirmasi.php?id=<?= $pecah['id_pembelian']; ?>" class="btn btn-success">konfirmasi barang diterima</a>
						<?php else: ?>
								<a href="lihatkonfirmasipelanggan.php?id=<?= $pecah['id_pembelian']; ?>" class="btn btn-warning">Lihat konfirmasi barang diterima</a>
								<?php endif; ?>
					</td>
				</tr>
				<?php endwhile; ?>
