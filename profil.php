...
if(isset($_POST['daftar'])){
  ...
  $ambil = $koneksi->query("SELECT * FROM pelanggan WHERE password_pelanggan='$password'");
  $yangcocok = $ambil->num_rows;
  if($yangcocok == 1){
    $koneksi->query("UPDATE pelanggan SET id_pelanggan='$_POST[id_pelanggan]', nama_pelanggan='$_POST[nama_pelanggan]', email_pelanggan='$_POST[email_pelanggan]', password_pelanggan='$_POST[password_pelanggan]', alamat_pelanggan='$_POST[alamat_pelanggan]', telepon_pelanggan='$_POST[Telepon_pelanggan]' WHERE id_pelanggan='$_GET[id]'");
  }
  else{
