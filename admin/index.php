...
<div id="wrapper">
	<nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
		<div class="navbar-header">
			...
			<a class="navbar-brand" >Ridwan Tempe</a> 
		</div>
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					<li class="text-center">
						<img src="assets/img/IMG-20230213-WA0005[1].jpg" class="user-image img-responsive"/>
					</li>
					<li>
			...
			<div id="page-inner">
				<?php
					if(isset($_GET["halaman"])){
						...
						elseif($_GET["halaman"] == "konfirmasipelanggan"){
							include 'konfirmasipelanggan.php';
						}
						elseif($_GET["halaman"] == "lihatkonfirmasipelanggan"){
							include 'lihatkonfirmasipelanggan.php';
						}
